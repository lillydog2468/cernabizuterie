...
BETLEMY = [
    ("Minimalistický betlém. 3 figurky, 700,- Kč.", "images/bet/3.jpg", "images/bet/3_t.jpg", "Betlém 3", "700,- Kč"),
    ("Malý betlém. 5 figurek, 1100,- Kč.", "images/bet/5.jpg", "images/bet/5_t.jpg", "Betlém 5", "1100,- Kč"),
    ("Menší betlém. 7 figurek, 1500,- Kč.", "images/bet/7.jpg", "images/bet/7_t.jpg", "Betlém 7", "1500,- Kč"),
    ("Základní betlém. 12 figurek, 2600,- Kč.", "images/bet/12.jpg", "images/bet/12_t.jpg", "Betlém 12", "2600,- Kč"),
    ("Ideální betlém. 15 figurek včetně chléva, 3500,- Kč.", "images/bet/15.jpg", "images/bet/15_t.jpg", "Betlém 15", "3500,- Kč"),
]
...
T = {
    "cs": {
        ...
        "footer_p3": 'Platba na dobírku při zaslání zboží nebo hotově při osobním odběru (po telefonické domluvě předem).',
        ...
        "betlemy": [
            "Minimalistický betlém. 3 figurky, 700,- Kč.",
            "Malý betlém. 5 figurek, 1100,- Kč.",
            "Menší betlém. 7 figurek, 1500,- Kč.",
            "Základní betlém. 12 figurek, 2600,- Kč.",
            "Ideální betlém. 15 figurek včetně chléva, 3500,- Kč.",
        ],
        "bet_label": "Betlém",
    ...
    "en": {
        ...
        "footer_p3": 'Cash on delivery when goods are shipped or cash on personal collection (by prior phone arrangement).',
        ...
        "betlemy": [
            "Minimalist nativity. 3 figures, 700,- Kč.",
            "Small nativity. 5 figures, 1100,- Kč.",
            "Smaller nativity. 7 figures, 1500,- Kč.",
            "Basic nativity. 12 figures, 2600,- Kč.",
            "Ideal nativity. 15 figures including the stable, 3500,- Kč.",
        ],
        "bet_label": "Nativity",
    ...
    "fr": {
        ...
        "footer_p3": 'Paiement contre remboursement à l’envoi ou en espèces lors d’un retrait en personne (après accord téléphonique préalable).',
        ...
        "betlemy": [
            "Crèche minimaliste. 3 figurines, 700,- Kč.",
            "Petite crèche. 5 figurines, 1100,- Kč.",
            "Crèche plus petite. 7 figurines, 1500,- Kč.",
            "Crèche de base. 12 figurines, 2600,- Kč.",
            "Crèche idéale. 15 figurines avec l’étable, 3500,- Kč.",
        ],
        "bet_label": "Crèche",
    ...
    "de": {
        ...
        "footer_p3": 'Zahlung per Nachnahme bei Versand oder bar bei persönlicher Abholung (nach vorheriger telefonischer Absprache).',
        ...
        "betlemy": [
            "Minimalistische Krippe. 3 Figuren, 700,- Kč.",
            "Kleine Krippe. 5 Figuren, 1100,- Kč.",
            "Kleinere Krippe. 7 Figuren, 1500,- Kč.",
            "Basis-Krippe. 12 Figuren, 2600,- Kč.",
            "Ideale Krippe. 15 Figuren inklusive Stall, 3500,- Kč.",
        ],
        "bet_label": "Krippe",
